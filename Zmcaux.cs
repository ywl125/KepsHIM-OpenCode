...
namespace cszmcaux
{
    ...
    public class zmcaux
    {
        ...
        /// <param name="ifsp">是否使用SP运动0/1, 缺省不使用</param>
        /// <returns>错误码</returns>
        [DllImport("zauxdll.dll", EntryPoint = "ZAux_Direct_MoveTrigger", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.StdCall)]
        public static extern Int32 ZAux_Direct_MoveTrigger(IntPtr handle, UInt32 base_axis, UInt32 iaxis, float fdist, UInt32 ifsp);
        ...
        /// <param name="handle">连接句柄</param>
        /// <param name="iaxis">轴号</param>
        /// <param name="mode">模式，0-清除当前轴，1-清除所有轴</param>
        /// <returns>错误码</returns>
        [DllImport("zauxdll.dll", EntryPoint = "ZAux_BusCmd_DriveClear", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.StdCall)]
        public static extern Int32 ZAux_BusCmd_DriveClear(IntPtr handle, int iaxis, int mode);
        ...
        /// <param name="handle">连接句柄</param>
        /// <param name="iaxis">轴号</param>
        /// <param name="piValue">返回的使能状态</param>
        /// <returns>错误码</returns>
        [DllImport("zauxdll.dll", EntryPoint = "ZAux_Direct_GetBusAxisEnable", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.StdCall)]
        public static extern Int32 ZAux_Direct_GetBusAxisEnable(IntPtr handle, int iaxis, ref int piValue);
